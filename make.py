...
licant.cxx_static_and_shared("libraries",
                             ...
                             cxxstd="c++2a",
                             ccstd="c11",
                             cxx_flags='-fmax-errors=1  -fconcepts -fPIC -Weffc++ -Wall -Wextra',
                             cc_flags='-fPIC',
...
licant.cxx_application("runtests",
                       ...
                       cxxstd="c++2a",
                       ccstd="c11",
                       cxx_flags="-fmax-errors=1  -fconcepts -Weffc++ -g -O0 -fPIC -Werror=all -Werror=pedantic -Wno-gnu-zero-variadic-macro-arguments",
