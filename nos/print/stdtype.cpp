...
int nos_print(nos::ostream& out, unsigned char obj) 	{ char buf[48]; __nos_itoa(obj, buf, 10); return nos_print(out, buf); }
int nos_print(nos::ostream& out, unsigned short obj) 	{ char buf[48]; __nos_itoa(obj, buf, 10); return nos_print(out, buf); }
int nos_print(nos::ostream& out, unsigned int obj) 	    { char buf[48];	__nos_itoa(obj, buf, 10); return nos_print(out, buf); }
int nos_print(nos::ostream& out, unsigned long obj) 	{ char buf[48];	__nos_itoa(obj, buf, 10); return nos_print(out, buf); }
int nos_print(nos::ostream& out, unsigned long long obj){ char buf[48];	__nos_itoa(obj, buf, 10); return nos_print(out, buf); }
